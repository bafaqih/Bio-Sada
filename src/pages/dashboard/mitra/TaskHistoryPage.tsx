...
/**
 * Task history page for partners.
...
export default function TaskHistoryPage() {
  ...
  const { data: result, isLoading } = usePartnerTaskHistory({
  ...
  return (
    ...
    >
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-gray-500">Daftar riwayat tugas penjemputan yang telah diselesaikan.</p>
      </div>
